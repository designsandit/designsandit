    ...
    <div id="tabs">
      <div class="tabs-shadow" >
        <div class="ui-tabs-panel ui-widget-content ui-corner-bottom ui-tabs-hide" id="tabs-1">
          <h1>Te notificaremos cuando el sitio esté online nuevamente </h1>
          <form method="post" id="searchform" action="#">
            <input type="text" value="<?php _e('Ingresa tu email') ?>" onfocus="if (this.value == '<?php _e('Ingresa tu email') ?>') {this.value = '';}" onblur="if (this.value == '') {this.value = '<?php _e('Ingresa tu email') ?>" name="tf_maintenance_email" id="searchinput" />
            <input type="submit" value="Enviar" id="searchsubmit" class="buttons"/>
          </form>
        </div>
        <div class="ui-tabs-panel ui-widget-content ui-corner-bottom ui-tabs-hide" id="tabs-2">
          <div id="last_tweet">Cargando el último tweet ...</div>
          <script>
